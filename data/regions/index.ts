// Export alle regio configuraties
export { loenenAanDeVechtConfig } from './loenen-aan-de-vecht';
export { loosdrechtConfig } from './loosdrecht';
export { breukelenConfig } from './breukelen';
...
// export { zandvoortConfig } from './zandvoort';
