...
export const knikhuisCronenburghLoenen: ProjectDetail = {
  slug: "architect-loenen-aan-de-vecht-knikhuis-cronenburgh",
  title: "Knikhuis Cronenburgh",
  subtitle:
    "Een markant knikhuis als stedenbouwkundige special op het Cronenburgherplein in Loenen aan de Vecht",
  ...
  seo: {
    title: "Knikhuis Cronenburgh Loenen aan de Vecht | Architect Jules Zwijsen",
    description:
      "Knikhuis als stedenbouwkundige special in Cronenburgh op het Cronenburgherplein, met verdraaide kap, abstracte gevels en sterke zichtlijnen.",
    keywords: [
      "knikhuis Cronenburgh",
  ...
  sections: [
...

    {
      ...
      layout: "image-left",
      fullWidth: false,
      title: "Het Knikhuis als Stedenbouwkundige Special",
      content:
...

    {
      ...
      origin:
        "De opdrachtgever zocht een bijzondere nieuwbouwwoning op kavel 11 in Cronenburgh, één van de stedenbouwkundige specials binnen het plan. De kavel ligt op de overgang van de Lutgerslaan naar het Cronenburgherplein, waar de stratenstructuur verdraait. De opgave was om deze stedenbouwkundige verdraaiing te vertalen naar een architectonisch statement dat het plein markeert en versterkt.",
      values: [
        "Stedenbouwkundige special",
        "Verdraaiing stratenstructuur als uitgangspunt",
        "Markering Cronenburgherplein",
        "Abstracte architectuur",
        "Sculpturaal volume",
        "Zichtlijnen als organiserend principe",
        "Privacy en daglicht in balans",
        "Garage als schuurinterpretatie"
      ],
      roleItems: [
        "Stedenbouwkundig: positionering op kruispunt van straten",
        "Ruimtelijk concept: knikhuis met verdraaide kap",
        "Gevelcompositie: abstracte gevels met strategische sparingen",
        "Interieur: zichtlijnen als organiserend principe",
        "Materialisatie: massief volume met strak gedetailleerde openingen",
        "Bijgebouw: garage met verwijzing naar lokale schuurarchitectuur"
      ]
    },
...

    {
      ...
      layout: "image-right",
      fullWidth: true,
      title: "Verdraaide Kap en Abstracte Gevelcompositie",
      content:
...

    {
      ...
      layout: "image-left",
      fullWidth: false,
      title: "Garage als Hedendaagse Interpretatie van de Schuur",
      content:
  ...
  cta: {
    ...
    headline:
      "Wilt u een architectonisch statement ontwerpen dat stedenbouwkundige kenmerken vertaalt naar karaktervolle architectuur?",
