...
export const moderneRecreatiewoningVecht: ProjectDetail = {
  slug: "architect-loenen-aan-de-vecht-moderne-recreatiewoning-vecht",
  title: "Moderne Recreatiewoning aan de Vecht",
  subtitle:
    "Flexibele recreatiewoning met verschuifbare panelen, souterrain en panoramisch uitzicht over de Vecht en weilanden",
  locationLabel: "Locatie: Vechtstreek",
  tags: [
    "Architect Loenen aan de Vecht",
    "Moderne recreatiewoning",
    "Recreatiewoning Vecht",
    "Woning met verschuifbare panelen",
    "Flexibele woning",
    "Souterrain woning",
    "Dakterras",
    "Uitzicht over de Vecht",
    "Weids landschap",
  ...
  seo: {
    ...
    title: "Architect Loenen aan de Vecht | Moderne Recreatiewoning Vecht",
    description:
      "Architect Loenen aan de Vecht: moderne recreatiewoning aan de Vecht met verschuifbare panelen, souterrain, dakterras en maximaal uitzicht op landschap.",
    keywords: [
      "architect Loenen aan de Vecht",
      "moderne recreatiewoning",
      "recreatiewoning Vecht",
      "flexibele woning met panelen",
      "woning met verschuifbare gevels",
      "souterrain recreatiewoning",
      "dakterras met uitzicht",
      "weids uitzicht weilanden",
  ...
  sections: [
...

    {
      ...
      origin:
        "De opdrachtgever zocht een recreatiewoning aan de Vecht met maximale flexibiliteit en ruimtelijkheid. Het bestemmingsplan stelde duidelijke randvoorwaarden aan volume en gebruik, maar de locatie bood grote kwaliteiten: een weids uitzicht over de Vecht en de omliggende weilanden, oude bomen en een ruim perceel. De opgave was om binnen deze beperkingen een woning te ontwerpen die meer kan bieden dan een standaard recreatieverblijf — een plek die kan meebewegen met seizoenen, weer en gebruik, en tegelijk maximaal profiteert van de unieke ligging.",
      values: [
        "Recreatiewoning binnen bestemmingsplan",
        "Verschuifbare panelen voor flexibiliteit",
        "Souterrain met daglicht door maaiveldverloop",
        "Woon-eetkeuken met rondom uitzicht",
        "Dakterras met panorama over Vecht en landschap",
        "Maximale relatie met weids landschap",
        "Volledig gesloten tot volledig geopend",
        "Flexibel gebruik door seizoenen en weer"
      ],
      roleItems: [
        "Stedenbouwkundig: positionering op ruim perceel met uitzicht over Vecht",
        "Ruimtelijk concept: verschuifbare panelen als sleutel tot flexibiliteit",
        "Programma: souterrain met slaapkamers, begane grond met woon-eetkeuken, dakterras",
        "Constructie: souterrain benut maaiveldverloop voor daglicht",
        "Gevel: verschuifbare panelen reguleren zon, wind, uitzicht en privacy",
        "Buitenruimte: dakterras op begane grond met spectaculair uitzicht"
      ]
    },
...

    {
      ...
      layout: "image-right",
      fullWidth: false,
      title: "Souterrain met daglicht dankzij het maaiveld",
      content:
   ...
   { type: "spacer", size: "lg" },
...

    {
      ...
      layout: "image-right",
      fullWidth: false,
      title: "Dakterras met spectaculair uitzicht",
      content:
  ...
  cta: {
    ...
    headline:
      "Recreatiewoningen ontwerpen die meebewegen met landschap en gebruik",
