...
import { BRAND_NAME, ADDRESS, EMAIL, PHONE_NUMBER, PROCESS_STEPS } from '../data';
import {
  Footer,
  InquiryOverlay,
  QuickscanOverlay,
...
export const Architect: React.FC = () => {
  ...
  // SEO management
  useEffect(() => {
    document.title = 'Architect Jules Zwijsen | Architect voor particuliere woningbouw';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Architect Jules Zwijsen ontwerpt en begeleidt particuliere woningbouw. Van maatwerk verbouwing tot nieuwbouw op eigen kavel. Persoonlijk en doordacht.');
    }
  }, []);
